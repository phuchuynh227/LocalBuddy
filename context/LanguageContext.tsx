...
const translations = {
  en: {
    ...
    myPlans: {
      ...
      requesterFallback: 'Buddy',
      locationPrefix: 'Location:',
      timePrefix: 'Time:',
      profilePreviewTitle: 'Profile preview',
      profilePreviewEmpty: 'This person only shares their avatar for now.',
    },
    forgotPassword: {
      ...
      successSubtitle: 'Check your inbox and follow the instructions to reset your password.',
    ...
    personalInfo: {
      title: 'Personal info',
      subtitle: 'Update your profile any time from Settings.',
      onboardingSubtitle: 'Add a few details so Local Buddy can introduce you better.',
      reminder: 'Give us a little info so we can take better care of you.',
      fullName: 'Full name',
      fullNamePlaceholder: 'E.g. Nguyen Minh Anh',
      nickname: 'Nickname',
      nicknamePlaceholder: 'What should Local Buddy call you?',
      gender: 'Gender',
      birthYear: 'Birth year',
      birthYearPlaceholder: 'E.g. 1998',
      interests: 'Interests',
      interestsPlaceholder: 'Coffee, running, movies, night markets...',
      visibilityTitle: 'Privacy',
      visibilitySubtitle: 'Choose what other people can see in your profile.',
  ...
  vn: {
    ...
    myPlans: {
      ...
      profilePreviewTitle: 'Xem nhanh thông tin',
      profilePreviewEmpty: 'Người này hiện chỉ chia sẻ avatar.',
    },
    forgotPassword: {
      title: 'Quên mật khẩu?',
      subtitle: 'Nhập email đăng ký của bạn, tụi mình sẽ gửi link đặt lại mật khẩu.',
      emailPlaceholder: 'Email',
      sendButton: 'Gửi link đặt lại',
      sending: 'Đang gửi...',
      successTitle: 'Đã gửi email!',
      successSubtitle: 'Kiểm tra hộp thư và làm theo hướng dẫn để đặt lại mật khẩu.',
    ...
    personalInfo: {
      ...
      subtitle: 'Bạn có thể cập nhật profile bất kỳ lúc nào trong Cài đặt.',
      onboardingSubtitle: 'Cho tụi mình xin xíu thông tin để giới thiệu bạn chu đáo hơn nha.',
      reminder: 'Cho tụi mình xin xíu info để lo cho bạn chu đáo hơn nha',
      fullName: 'Họ tên',
      fullNamePlaceholder: 'VD: Nguyễn Minh Anh',
      nickname: 'Nickname',
      nicknamePlaceholder: 'Mọi người nên gọi bạn là gì?',
      gender: 'Giới tính',
      birthYear: 'Năm sinh',
      birthYearPlaceholder: 'VD: 1998',
      interests: 'Sở thích',
      interestsPlaceholder: 'Cà phê, chạy bộ, xem phim, ăn vặt...',
      visibilityTitle: 'Quyền hiển thị',
      visibilitySubtitle: 'Chọn thông tin nào người khác được xem trong hồ sơ của bạn.',
